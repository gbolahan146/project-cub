...
class AuthHttpService extends AlsBaseHttpService implements AuthService {
  ...
  @override
  Future<Response> setupPin({required Map<String, dynamic> data}) async {
    try {
      final res = await http.post(CbEndpoints.setUpPin, data: data);
      return res;
    } on DioError catch (e) {
      throw e;
    } on Exception catch (e) {
  ...
  @override
  Future<Response> validatePin({required Map<String, dynamic> data}) async {
    try {
      final res = await http.post(CbEndpoints.validatePin, data: data);
      return res;
    } on DioError catch (e) {
      throw e;
    } on Exception catch (e) {
